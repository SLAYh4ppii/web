            ...
            <div className="row justify-content-center mt-10 mt-md-20">
              <div className="col-lg-5">
                <div className="join-us text-center">
                  ...
                  <p>
                    Still haven&apos;t found your dream job? Join Team RickedStudios
                    and become the next RickedStudios of an ever-growing family!
                  </p>
...
export default LifeRickedStudio;
